...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-12">
			<h1 class="page-header">
				Blog Home 1 <small>Blog Homepage</small>
			</h1>
			<ol class="breadcrumb">
	...
	<div class="row">
		...
		<div class="col-lg-8">
			...
			<hr>
			<a href="blog-post.html"> <img src="http://placehold.it/900x300"
				class="img-responsive">
			</a>
			<hr>
			<p>This is a very basic starter template for a blog homepage. It
				makes use of Font Awesome icons that are built into the 'Modern
				Business' template, and it makes use of the Bootstrap 3 pager at the
				bottom of the page.</p>
			<a class="btn btn-primary" href="blog-post.html">Read More <i
				class="fa fa-angle-right"></i></a>

			<hr>

			<h1>
				<a href="blog-post.html">Another Blog Post</a>
			</h1>
			<p class="lead">
				by <a href="#">Start Bootstrap</a>
			</p>
			...
			<p>Science cuts two ways, of course; its products can be used for
				...
				early warnings about technological dangers also come from science...</p>
			<a class="btn btn-primary" href="blog-post.html">Read More <i
				class="fa fa-angle-right"></i></a>
			...
			<h1>
				<a href="blog-post.html">Third Blog Post Entry</a>
			</h1>
			<p class="lead">
				by <a href="#">Start Bootstrap</a>
			</p>
